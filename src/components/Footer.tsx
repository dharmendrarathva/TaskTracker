  ...
  return (
    <footer className="w-full border-t border-white/10 bg-neutral-950 text-neutral-300">
      <div className="max-w-7xl mx-auto px-6 py-12 grid gap-10 md:grid-cols-4">
        ...
        <div>
          <Link href="/">
            <h2 className="text-2xl font-semibold text-white mb-3 flex items-center gap-2 cursor-pointer">
              <TbTargetArrow className="text-amber-400" />
              Task Tracker
            </h2>
          </Link>

          <p className="text-sm text-neutral-400 leading-relaxed">
            Plan smarter. Track progress. Achieve your goals with clarity and focus.
          </p>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            ...
            <li>
              <Link href="/myplans" className="hover:text-white transition">
                My Plans
              </Link>
            </li>
            <li>
